...
import { updateAdmissionProcessData } from "../../Services/Actions/actions";
import classes from "../css/AdmissionProcessTemplate1Component.module.css";
...
import { admissionProcessObj } from "../../data/schema";
...
function AdmissionProcessTemplate1Component(props) {
  const data = props.admissionProcessPageData.admissionProcess;
  const dummyObj = admissionProcessObj;
          ...
          <div className={classes["text"]}>
            <div>
              ...
              <p className="breadcrumbs">
                ...
                <span>
                  admissionProcess <i className="ion-ios-arrow-forward"></i>
                </span>
              </p>
            </div>
          </div>
...
const mapDispatchToProps = (dispatch) => ({
  updateData: (data, sectionName) =>
    dispatch(updateAdmissionProcessData(data, sectionName)),
});

export default connect(
  mapStateToProps,
  mapDispatchToProps
)(AdmissionProcessTemplate1Component);
