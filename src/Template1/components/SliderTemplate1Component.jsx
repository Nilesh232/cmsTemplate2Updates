...
import { sliderObj } from "../../data/schema";
...
function SliderTemplate1Component(props) {
  const data = props.homePageData.slider;
  const dummyObj = sliderObj;
  ...
  return (
    <>
      ...
      <OwlCarousel className="home-slider owl-carousel"
      loop= {false} rewind={true} autoplay={true} margin={0}  animateOut={"fadeOut"} animateIn={"fadeIn"} nav={false} autoplayHoverPause={false} 
      items = {1} navText = {[
          ...
          <div className="container">
            ...
            >
              <div className="col-md-6">
                <h1 className="mb-4">{val.title}</h1>
...
export default connect(mapStateToProps,mapDispatchToProps)(SliderTemplate1Component);
