...
import classes from "../css/TeachingTemplate1Component.module.css";
...
import { updateTeachingData } from "../../Services/Actions/actions";
import { sortByKey } from "../../utilities/helper/helper";

import AddSectionModal from "../AddSectionModal";
import { teachingObj } from "../../data/schema";

function Alert(props) {
  return <MuiAlert elevation={6} variant="filled" {...props} />;
}

function TeachingTemplate1Component(props) {
  const data = props.teachingPageData.teaching;
  const dummyObj = teachingObj;
          ...
          <div className={classes["text"]}>
            <div>
              ...
              <p className="breadcrumbs">
                ...
                <span>
                  Teaching Methodology <i className="ion-ios-arrow-forward"></i>
                </span>
              </p>
            </div>
          </div>
                              ...
                              <div className="col-lg-5 col-md-5 col-sm-12 ">
                                <img
                                  ...
                                  className={
                                    classes["teachingImg"] +
                                    " " +
                                    "p-3 mb-5  rounded  p-3 mb-5 rounded"
                                  }
                                  src='/static/images/template1/kid1.jpg'
                                />{" "}
                              </div>
...
const mapDispatchToProps = (dispatch) => ({
  updateData: (data, sectionName) =>
    dispatch(updateTeachingData(data, sectionName)),
});

export default connect(
  mapStateToProps,
  mapDispatchToProps
)(TeachingTemplate1Component);
