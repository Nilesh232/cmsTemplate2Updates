...
function TeacherTemplate1Component(props) {
    const classes = useStyles();
    const data = props.teacherPageData.teacher;
    ...
    return (
        ...
        >
          ...
          <div className={classes["text"]}>
            <div>
              <h1 className={classes['h1']}>{"Teachers"}</h1>
              <p className="breadcrumbs">
                ...
                <span>
                  Teacher <i className="ion-ios-arrow-forward"></i>
                </span>
              </p>
            </div>
          </div>
                  ...
                  <div className="col-md-5 col-sm-12">
                    ...
                    >
                      ...
                      {val.text.map((contentInfo, kdx) => (
                        <h4 className="text-muted my-4">{contentInfo}</h4>
                        ))}
                    </div>
                  </div>
                  </>
...
const mapDispatchToProps = (dispatch) => ({
  updateData: (data, sectionName) =>
    dispatch(updateTeacherData(data, sectionName)),
});

export default connect(
  mapStateToProps,
  mapDispatchToProps
)(TeacherTemplate1Component)
