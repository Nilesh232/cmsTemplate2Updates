...
import classes from "../css/ContactTemplate1Component.module.css";
...
import { updateContactData } from "../../Services/Actions/actions";
import { sortByKey } from "../../utilities/helper/helper";
import { contactObj } from "../../data/schema";
...
function ContactTemplate1Component(props) {
  const data = props.contactPagaeData.contact;
  const dummyObj = contactObj;
                ...
                <>
                  <div className={editClass + "-section"}>
                    ...
                    <div className={classes["card"]}>
                      ...
                      >
                        <h3 className={classes["mb-4"]}>{val.title}</h3>
...
const mapDispatchToProps = (dispatch) => ({
  updateData: (data, sectionName) =>
    dispatch(updateContactData(data, sectionName)),
});

export default connect(
  mapStateToProps,
  mapDispatchToProps
)(ContactTemplate1Component);
